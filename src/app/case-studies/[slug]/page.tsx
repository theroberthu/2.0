        ...
        <div className="max-w-3xl mx-auto px-5 sm:px-8 space-y-16">
          ...
          <section>
            <div className="flex items-center gap-3 mb-5">
              <div className="w-9 h-9 rounded-lg bg-red-500/[0.12] flex items-center justify-center">
          ...
          <section>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-9 h-9 rounded-lg bg-emerald-500/[0.12] flex items-center justify-center">
                <svg className="w-[18px] h-[18px] text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                </svg>
              </div>
              <h2 className="text-xl font-semibold text-white">The Results</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pl-12">
              {cs.results.map((result: string, i: number) => (
                <div
                  key={i}
                  className="bg-white/[0.05] backdrop-blur-md border border-white/[0.08] rounded-xl p-5"
                >
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-brand-gold/[0.15] flex items-center justify-center shrink-0 mt-0.5">
          ...
          <section className="border-l-[3px] border-brand-accent pl-6 py-2">
            ...
            <blockquote className="text-lg font-medium text-gray-300 leading-relaxed italic">
